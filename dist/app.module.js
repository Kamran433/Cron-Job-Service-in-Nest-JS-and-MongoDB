...
const products_schema_1 = require("./products/dto/products.schema");
...
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            mongoose_1.MongooseModule.forFeature([{ name: 'productos', schema: products_schema_1.productSchema }]),
        ],
